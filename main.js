...
const weatherAPIKey = "9edf60f3061aeafa1a89fcc2d411dc57";
...
function menuHandler(){
    ...
    /* classList is read only property which return CSS classes in the form oa an Array(allow us to add,remove,toggle,click)*/
...
function greetingHandler(){
    ...
    /*Greeting chnage on cureent timeing*/
    let greetingText ;
    if (currentHour <12){
...
function galleryHandler(){
    ...
    galleryImages.forEach(function(image,index){
        ...
        thumb.addEventListener("click",function(e){
            //selecting and checking the thumbnail
            ...
            //after selecting another thumbnail its previous selected whitw higlighted is removed
            thumbnails.querySelectorAll("img").forEach(function(img){
                img.dataset.selected = false
            });
            
            //showing which thumbnail is selected
...
function populateProducts(productsList){
    ...
    productsList.forEach(function(product,index){
        //Ceate the HTML element for the individual product
        ...
        //Create product titile.author,pricetitle and price
...
function footerHandler(){
    ...
    document.querySelector("footer").textContent = `${currentYear} - All rights reserved Boi`;
}
